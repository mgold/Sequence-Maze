...
Elm.Graphics.Input.make = function (_elm)
                          {
                            ...
                            var FieldContent = F2(function (a,b)
                                                  {
                                                    return {_: {}, selection: b, string: a};
                                                  });
                            var noContent = A2(FieldContent,"",A3(Selection,0,0,Forward));
                            ...
                            _elm.Graphics.Input.values = {_op: _op, input: input, button: button, customButton: customButton, checkbox: checkbox, dropDown: dropDown, hoverable: hoverable, clickable: clickable, noContent: noContent, field: field, password: password, email: email, Handle: Handle, Forward: Forward, Backward: Backward, Input: Input, FieldContent: FieldContent, Selection: Selection};
                            return _elm.Graphics.Input.values;
                          };Elm.JavaScript = Elm.JavaScript || {};
